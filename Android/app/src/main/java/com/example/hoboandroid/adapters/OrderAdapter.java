...
public class RecyclerViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    public void bind(OrderData orderData){
        ...
        address.setText(orderData.getAddress1()+" "+orderData.getAddress2()+" "+ orderData.getCity() + " " + orderData.getPincode() + " " +orderData.getPincode());
        deliveryDate.setText(Double.toString(orderData.getDeliveryDate()));
        orderDate.setText(Double.toString(orderData.getOrderDate()));
